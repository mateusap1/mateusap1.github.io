export default () => {
  return (
    <div className="w-80 h-80 gap-4 flex flex-col border-2 border-[#8EA7CA] rounded-lg">
      ...
      <div className="px-8 pb-4 pt-4 h-full flex flex-col gap-4 border-t-2 border-[#8EA7CA] hover:bg-[#8EA7CA] hover:cursor-pointer transition duration-150 ease-in-out">
